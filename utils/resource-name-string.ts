...
export class ResourceNameString {
  ...
  getPascalCaseWithAccountIdSpecificRegion(region: string): string {
    return this.getNameWithAccountIdSpecificRegion(region, CaseStyle.PASCAL);
  }

  getSnakeCaseWithAccountIdSpecificRegion(region: string): string {
    return this.getNameWithAccountIdSpecificRegion(region, CaseStyle.SNAKE);
  }

  getKebabCaseWithAccountIdSpecificRegion(region: string): string {
    return this.getNameWithAccountIdSpecificRegion(region, CaseStyle.KEBAB);
  }

  private getNameWithAccountIdSpecificRegion(region: string, caseStyle: CaseStyle): string {
